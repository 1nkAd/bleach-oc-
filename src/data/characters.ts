...
export const characters: Record<string, CharacterProfile> = {
  adham: {
    ...
    dossier: {
      ...
      zanpakuto: { name: 'Dankai', translation: 'Severing Realm' },
    ...
    abilities: [
      {
        name: 'Shikai: Dankai (Severing Realm)',
        type: 'INITIAL RELEASE',
        description: "Release: 「断て — 断界」 — Tate — Dankai — \"Sever — Dankai.\"\n\nThe standard katana dissolves and violently reconstructs into a pair of dense, segmented black gauntlets extending past his elbows, featuring lethal, forward-facing tonfa-blades resting parallel to his forearms."
      },
      {
    ...
    lore: [
      ...
      },
      {
        ...
        description: "Raw reiatsu output above a certain tier — Yamamoto-level pressure collapses the fight before it becomes a fight. He has no answer for that category of problem.\n\nAging, time, and passive decay effects — Structural Null has nothing to unmake. No defensive layer against abilities that operate on existence rather than reiatsu architecture.\n\nAbilities that don't require soul-reading — Reiatsu Interference is irrelevant against brute-force physical attacks.\n\nSoul Fission contact requirement — Against high-speed or precognitive opponents, landing the nodachi stab on the soul core is the entire fight. If he can't land it, the win condition doesn't exist.\n\nNakigara's secondary trigger burns the mask — If Nakigara fires Soul Fission as a burst and the attempt fails, Adham loses Hollow enhancement for the rest of the fight. One attempt. No reset.\n\nTrue Bankai duration — More efficient than his current Bankai, but not unlimited. Against attrition fighters, time is a weapon against him."
      }
    ],
    gallery: [
